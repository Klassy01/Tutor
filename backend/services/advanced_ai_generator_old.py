    ...
    def _create_fallback_lesson(self, subject: str, topic: str, difficulty: str) -> Dict[str, Any]:
        ...
        try:
            lesson_content = await ai_model_manager.generate_content(
                content_type="lesson",
                prompt=f"Create a comprehensive lesson about '{topic}' in {subject}. Include:\n1. A brief clear explanation of what {topic} is\n2. Why it's important in {subject}\n3. Key concepts and principles\n4. Real-world examples and applications\n5. Step-by-step learning approach\n\nMake it educational, engaging, and easy to understand.",
                max_tokens=1000
            )
...
## What is {topic}?
{topic} is a fundamental concept in {subject} that plays a crucial role in understanding how systems work and interact. It represents the relationship between different variables and helps us make predictions and understand patterns.
...
## Key Concepts
• **Definition**: Clear understanding of what {topic} means
• **Applications**: How {topic} is used in real scenarios
• **Methods**: Different approaches to work with {topic}
• **Analysis**: Ways to interpret and evaluate {topic} results

## Learning Path
1. **Foundation**: Start with basic definitions and concepts
2. **Examples**: Study practical applications and case studies  
3. **Practice**: Work through problems and exercises
4. **Application**: Apply knowledge to new situations

## Real-World Applications
{topic} appears in many areas including business analytics, scientific research, technology development, and decision-making processes. Understanding {topic} helps you analyze trends, make predictions, and solve problems effectively.
"""
        ...
        return {
            "lesson": {
                ...
                "content": {
                    ...
                    "key_concepts": [
                        f"What {topic} is and why it matters",
                        f"Core principles and methods of {topic}",
                        f"Practical applications in {subject}",
                        "Problem-solving strategies",
                        "Real-world examples and case studies"
                    ],
                    "examples": [
                        {
                            "Basic Application": f"How {topic} applies in everyday {subject} scenarios"
                        },
                        {
                            "Advanced Implementation": f"Complex applications of {topic} in professional {subject} work"
                        },
                        {
                            "Case Study": f"Real-world success story using {topic} principles"
                        }
                    ]
                },
            ...
            "success": True,
            "message": f"Successfully generated lesson on {topic}"
        }
